...
VL_INLINE_OPT void Vtop___024root___nba_sequent__TOP__0(Vtop___024root* vlSelf) {
    ...
    vlSelf->sampling = (IData)((4U == (6U & (IData)(vlSelf->top__DOT__keyboard__DOT__ps2_clk_sync))));
}
...
VL_INLINE_OPT void Vtop___024root___nba_sequent__TOP__1(Vtop___024root* vlSelf) {
    ...
    __Vtableidx7 = 0;
    CData/*0:0*/ __Vdly__top__DOT__got_f0;
    __Vdly__top__DOT__got_f0 = 0;
    CData/*7:0*/ __Vdly__top__DOT__num;
    __Vdly__top__DOT__num = 0;
    // Body
    __Vdly__top__DOT__num = vlSelf->top__DOT__num;
    __Vdly__top__DOT__got_f0 = vlSelf->top__DOT__got_f0;
    if (vlSelf->clrn) {
        if (vlSelf->ready) {
            vlSelf->top__DOT__data_buf = vlSelf->top__DOT__data;
            if ((0xf0U == (IData)(vlSelf->top__DOT__data))) {
                __Vdly__top__DOT__got_f0 = 1U;
            } else if (vlSelf->top__DOT__got_f0) {
                __Vdly__top__DOT__num = (0xffU & ((IData)(1U) 
                                                  + (IData)(vlSelf->top__DOT__num)));
                vlSelf->top__DOT__num_digit_1 = (0xfU 
                                                 & (IData)(vlSelf->top__DOT__num));
                vlSelf->top__DOT__scan_code = 0U;
                vlSelf->top__DOT__num_digit_2 = (0xfU 
                                                 & ((IData)(vlSelf->top__DOT__num) 
                                                    >> 4U));
                __Vdly__top__DOT__got_f0 = 0U;
            } else {
                vlSelf->top__DOT__scan_code = vlSelf->top__DOT__data;
            }
        }
    } else {
        vlSelf->top__DOT__data_buf = 0U;
        __Vdly__top__DOT__got_f0 = 0U;
        __Vdly__top__DOT__num = 0U;
    }
    vlSelf->top__DOT__got_f0 = __Vdly__top__DOT__got_f0;
    vlSelf->top__DOT__num = __Vdly__top__DOT__num;
    __Vtableidx6 = vlSelf->top__DOT__num_digit_1;
    vlSelf->seg4 = Vtop__ConstPool__TABLE_hb2a417e2_0
        [__Vtableidx6];
    __Vtableidx7 = vlSelf->top__DOT__num_digit_2;
    ...
    vlSelf->seg0 = Vtop__ConstPool__TABLE_hb2a417e2_0
        [__Vtableidx2];
    __Vtableidx3 = (0xfU & ((IData)(vlSelf->top__DOT__scan_code) 
                            >> 4U));
    vlSelf->seg1 = Vtop__ConstPool__TABLE_hb2a417e2_0
        [__Vtableidx3];
    __Vtableidx1 = vlSelf->top__DOT__scan_code;
    vlSelf->top__DOT__ascii_code = Vtop__ConstPool__TABLE_h5058f713_0
        [__Vtableidx1];
    __Vtableidx4 = (0xfU & (IData)(vlSelf->top__DOT__ascii_code));
    vlSelf->seg2 = Vtop__ConstPool__TABLE_hb2a417e2_0
        [__Vtableidx4];
    __Vtableidx5 = (0xfU & ((IData)(vlSelf->top__DOT__ascii_code) 
                            >> 4U));
...
VL_INLINE_OPT void Vtop___024root___nba_sequent__TOP__2(Vtop___024root* vlSelf) {
    ...
    vlSelf->top__DOT__data = vlSelf->top__DOT__keyboard__DOT__fifo
...
#endif
                VL_FATAL_MT("/home/tree/ysyx-workbench/nvboard/exercise/exercise8/vsrc/top.v", 1, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("/home/tree/ysyx-workbench/nvboard/exercise/exercise8/vsrc/top.v", 1, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("/home/tree/ysyx-workbench/nvboard/exercise/exercise8/vsrc/top.v", 1, "", "NBA region did not converge.");
            }
